...
public class UserUpdatePage extends JDialog {
	...
	static UserUpdatePage updatedialog = new UserUpdatePage();
	...
	public static void main(String[] args) {
		try {
			updatedialog = new UserUpdatePage();
	...
	private JButton getBtnNewButton_2() {
		if (btnNewButton_2 == null) {
			...
			btnNewButton_2.setIcon(new ImageIcon(UserUpdatePage.class.getResource("/com/javalec/image/home1.png")));
